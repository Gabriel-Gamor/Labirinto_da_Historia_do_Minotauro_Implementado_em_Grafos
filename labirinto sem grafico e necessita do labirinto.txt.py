...
def main():
    # Função de entrada do script. Lê argumento de linha de comando (opcional) para o arquivo do labirinto.
    if len(sys.argv) >= 2:
        # se passado argumento, usa-o como nome do arquivo
        arquivo = sys.argv[1]
    else:
        # caso contrário, considera "labirinto.txt" por padrão
